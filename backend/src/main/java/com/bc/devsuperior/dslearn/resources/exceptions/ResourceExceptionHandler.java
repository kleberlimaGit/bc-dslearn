package com.bc.devsuperior.dslearn.resources.exceptions;
...
import com.bc.devsuperior.dslearn.services.exception.DatabaseException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<ValidationError> argumentNotValid(MethodArgumentNotValidException e, HttpServletRequest request){
		...
		HttpStatus status = HttpStatus.UNPROCESSABLE_ENTITY;// 422 significa que alguma entidade nao foi possivel de ser processada
